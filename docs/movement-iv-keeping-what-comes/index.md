...
- **The wineskin.** Jesus' warning that new wine bursts old wineskins, taken seriously as a law of institutions: every fresh work routinizes, and what keeps a wineskin supple is designed renewal — including a willingness to let structures (even this pilot's structures) be examined, refreshed, and if need be, retired.
- **Handing the fire to the next generation.** Faith is not heritable; the *conditions* of faith are. What the record and the research say about how revival's children either inherit living fire or a photograph of one — warmth as the carrier, honest questions welcomed rather than managed, and a household and church culture that provokes the next generation to ask for the real thing.

The movement — and the book — closes where it began: with the two questions, now fully informed. Do you want a revival? And now that you know what the soil requires: will you begin?
