...
- **The reviews themselves, on request.** The summary above will serve most readers. The individual review documents — the full written-in-voice panels and their verification passes — are preserved and available from the author on request.
- **Pointers and further reading** — where each thread continues in *Intentional Journey of the Heart* and in the [*Fellowship of the Heart*](https://jgtittle-ministries.github.io/fellowship-of-the-heart-pilot-at-cca/) pilot materials.
