...
const SERIES_DEFS = [
  { id: 'movement-i-do-you-want-a-revival',  name: 'Movement I — Do You Want a Revival?',  edition: null },
  { id: 'movement-ii-what-is-your-soil',     name: 'Movement II — What Is Your Soil?',     edition: null },
  { id: 'movement-iii-preparing-the-soil',   name: 'Movement III — Preparing the Soil',    edition: null },
  { id: 'movement-iv-keeping-what-comes',    name: 'Movement IV — Keeping What Comes',     edition: null },
  { id: 'reference',                         name: 'Reference',                            edition: null }
];
