...
**This is the working DEV repository.** Content here is draft, under active revision, and not yet authoritative. The published edition will live at [`a-church-prepared-for-revival-a-pilot-proposed`](https://github.com/jgtittle-ministries/a-church-prepared-for-revival-a-pilot-proposed) once mirrored (that repository is created at the first mirror, so the link is dormant until then).

**Read the book:** https://jgtittle-ministries.github.io/a-church-prepared-for-revival-a-pilot-proposed-dev/
